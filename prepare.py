...
'''
temp_img = cv2.imread("images\M-34-51-C-d-4-1.tif") #3 channels / spectral bands
plt.imshow(temp_img[:,:,2]) #View each channel...
temp_mask = cv2.imread("masks\M-34-51-C-d-4-1.tif") #3 channels but all same. 
...
#Checking for a random image in the dataset
'''
